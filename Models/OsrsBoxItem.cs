...
/***
 * TODO ~ Write a integration test, to test against the remote OSRSBox item schema, to find any values that aren't in this class
 * TODO ~ This could be improved by creating a Snake_Case converter that's applied automatically
 * could remove all the json properties for a much cleaner looking model
 */
...
namespace OsItemIndex.Data
{
    ...
    public class Equipment
    {
        ...
        public class WeaponStance
        {
            ...
            public WeaponBoosts? Boosts { get; set; }

            [JsonPropertyName("combat_style")]
            public WeaponCombatStyle? CombatStyle { get; set; }

            [JsonPropertyName("experience")]
            public WeaponExperienceStyle? Experience { get; set; }
        }
